...
void set_boot_args(struct sbi_trap_regs *regs)
{
	sbi_printf("entry set_boot_args\n");

	EFI_SECURE_SHARED_BUFFER *MmSharedBuffer = (EFI_SECURE_SHARED_BUFFER *)0x80B00000;
	...
	regs->a1 = (uintptr_t)&MmSharedBuffer->MmPayloadBootInfo;
}
